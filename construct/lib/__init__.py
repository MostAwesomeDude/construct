...
from construct.lib.py3compat import PY, PY2, PY3, PY27, PY32,PY33, PY34, PY35, PY36, PY37, PYPY, supportskwordered, stringtypes, stringbytetype, int2byte, byte2int, str2bytes, bytes2str, str2unicode, unicode2str, iteratebytes, iterateints
...
__all__ = [
    ...
    'PY','PY2', 'PY3', 'PY27', 'PY32','PY33', 'PY34', 'PY35','PY36', 'PY37','PYPY', 'supportskwordered','stringtypes', 'stringbytetype', 'int2byte', 'byte2int', 'str2bytes', 'bytes2str', 'str2unicode', 'unicode2str', 'iteratebytes', 'iterateints',
