...
all_tests = [
    ...
    [Struct("a" / ULInt16, "b" / Byte).parse,
        b"\x01\x00\x02", Container(a=1)(b=2), None],
    [Struct("a" / Byte, "b" / UBInt16, "inner" / Struct("c" / Byte, "d" / Byte)).parse,
        b"\x01\x00\x02\x03\x04", Container(a=1)(b=2)(inner=Container(c=3)(d=4)), None],
    [Struct("a" / Byte, "b" / UBInt16, Embedded("inner" / Struct("c" / Byte, "d" / Byte))).parse,
        b"\x01\x00\x02\x03\x04", Container(a=1)(b=2)(c=3)(d=4), None],
    [Struct("a" / ULInt16, "b" / Byte).build,
        Container(a=1)(b=2), b"\x01\x00\x02", None],
    [Struct("a" / Byte, "b" / UBInt16, "inner" / Struct("c" / Byte, "d" / Byte)).build,
        Container(a=1)(b=2)(inner=Container(c=3)(d=4)), b"\x01\x00\x02\x03\x04", None],
    [Struct("a" / Byte, "b" / UBInt16, Embedded("inner" / Struct("c" / Byte, "d" / Byte))).build,
        Container(a=1)(b=2)(c=3)(d=4), b"\x01\x00\x02\x03\x04", None],
