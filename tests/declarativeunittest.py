...
class TestCase(unittest.TestCase):
    ...
    def test_suite(self):
        if not hasattr(self, "alltests"):
            return

        errors = []
        for i, line in enumerate(self.alltests):
    ...
    def test_suite_yields(self):
        if not hasattr(self, "alltestsinteractive"):
            return

        errors = []
        for i, line in enumerate(self.alltestsinteractive()):
